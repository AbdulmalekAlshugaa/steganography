package com.Rakan.imagesteganographylibrary.Utils;
...
public class Crypto {
    ...
    public static String encryptMessage(String message, String secret_key) throws Exception {
        ...
        SecretKeySpec aesKey = new SecretKeySpec(secret_key.getBytes(), "AES"); // using AES encryptin to secure the secert key
        Cipher cipher;
